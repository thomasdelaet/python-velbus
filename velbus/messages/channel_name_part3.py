...
class ChannelNamePart3Message(velbus.Message):
    """
...
velbus.register_command(COMMAND_CODE, ChannelNamePart3Message2, 'VMBGP1')
velbus.register_command(COMMAND_CODE, ChannelNamePart3Message2, 'VMBGP2')
